      ...
      >
          ...
          <div className="payment-methods">
            <button
              className={`payment-method ${
                selectedPaymentMethod === "JazzCash" ? "active" : ""
              }`}
            ...
            <button
              className={`payment-method ${
                selectedPaymentMethod === "EasyPaisa" ? "active" : ""
              }`}
              onClick={() => setSelectedPaymentMethod("EasyPaisa")}
            >
              <img
                src="https://websol.biz/wp-content/uploads/2020/09/jazzcash_small-removebg-preview.png"
                alt="EasyPaisa"
                className="payment-logo"
              />
              EasyPaisa
            ...
            <div className="payment-details">
              {selectedPaymentMethod === "JazzCash" && (
                <>
                  ...
                  />
                  <p className="note">
                    Ensure your JazzCash account is active and has sufficient
                    balance.
                  </p>
                </>
              )}
              {selectedPaymentMethod === "EasyPaisa" && (
                <>
                  ...
                  />
                  <p className="note">
                    Ensure your EasyPaisa account is active and has sufficient
                    balance.
                  </p>
                </>
              )}
              {selectedPaymentMethod === "Bank" && (
                <>
                  ...
                  />
                  <p className="note">
                    Ensure your bank account has sufficient balance for the
                    transaction.
                  </p>
                </>
              )}
        ...
        <div className="order-summary-section">
          ...
          <div className="order-details">
            ...
            <h4>
              Total Amount: <strong>PKR 8000</strong>
            </h4>
          </div>
