    ...
    <div className="artist-popup-overlay">
      <div className="artist-popup">
        <div className="artist-popup-header">
          <h2>{event.title}</h2>
          <button className="artist-popup-close" onClick={onClose}>X</button>
        </div>
        ...
        <div className="artist-popup-body">
          <div className="artist-popup-left">
            ...
            <div className="artist-event-detail">
              <FontAwesomeIcon icon={faMapMarkerAlt} className="artist-event-icon" />
            ...
            <button className="artist-make-payment-btn">Make Payment</button>
          </div>

          <div className="artist-popup-right">
            <div className="artist-event-progress">
              <FontAwesomeIcon icon={faCheckCircle} className="artist-progress-icon" />
              <p>Artist Dispatched</p>
            </div>
            <div className="artist-event-progress">
              <FontAwesomeIcon icon={faHourglassHalf} className="artist-progress-icon" />
              <p>In Transit</p>
            </div>
            <div className="artist-event-progress">
              <FontAwesomeIcon icon={faExclamationCircle} className="artist-progress-icon" />
              <p>Arrived at Venue</p>
            </div>
            <div className="artist-event-progress">
              <FontAwesomeIcon icon={faPlayCircle} className="artist-progress-icon" />
              <p>Event Started</p>
            </div>
            <div className="artist-event-progress">
              <FontAwesomeIcon icon={faCheckCircle} className="artist-progress-icon" />
